        ...
        for (let COURSE_ID of CURSOS_IDS) {
            ...
            for (let aluno of alunos) {
                ...
                if (atividadesPendentes.length > 0) {
                    ...
                    htmlMsg += `</ul><p>Se estiver com alguma dúvida na matéria para fazer essas entregas, clique no meu botão lá no ambiente do curso e vamos bater um papo! Estou aqui para te ajudar. 🚀</p>`;
                } else {
